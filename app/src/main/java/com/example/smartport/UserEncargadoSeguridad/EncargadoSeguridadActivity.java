...
public class EncargadoSeguridadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_encargadoseguridad);
    ...
    public class MiPagerAdapter extends FragmentStateAdapter {
        ...
        public Fragment createFragment(int position) {
            switch (position) {
                case 0:
                    return new Tab1EncargadoSeguridad(); // 暂不实现
                case 1:
                    return new Tab2EncargadoSeguridad();
            }
            return new Tab1EncargadoSeguridad();
        }
    }
}